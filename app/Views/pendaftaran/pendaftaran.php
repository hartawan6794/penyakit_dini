...
<div class="card">
  <div class="card-header">
    <div class="row">
      ...
      <div class="col-3">
        <button type="button" class="btn float-end btn-success" id="create-pendaftaran" title="<?= lang("Tambah") ?>"> <i class="fa fa-plus"></i> <?= lang('Tambah') ?></button>
      </div>
    </div>
  </div>
  <!-- /.card-header -->
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group mb-3">
                ...
                <input type="date" id="tanggal_daftar" name="tanggal_daftar" class="form-control" dateISO="true" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
