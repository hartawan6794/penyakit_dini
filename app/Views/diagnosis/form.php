        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="form-diagnosa">
                    <div class="row">
                        <input type="hidden" id="id_diagnosis" name="id_diagnosis" class="form-control" placeholder="Id" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pasien_data" id="pasien_data" class="form-control">
                                            ...
                                            <?php foreach ($pasien as $value) : ?>
                                                <option value="<?= $value['pasien_id'] ?>"><?= $value['nama_pasien'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="40" rows="5" id="catatan" name="catatan" class="form-control" placeholder="Catatan diagnosis pasien"></textarea>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pilih_obat" id="pilih_obat" class="form-control" multiple="multiple">
                                            <?php foreach ($obat as $value) : ?>
                                                <option value="<?= $value->id ?>" data-nama="<?= $value->nama_obat ?>" data-dosis="<?= $value->dosis ?>"><?= $value->nama_obat ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
...
<script>
    ...
    $(function() {
        ...
        $("#pilih_obat").on('change', function(e) {
        ...
        $('#form-btn').on('click', function(e) {
            ...
            // var form = $('#form-daignosis').serialize();
            var formData = {};
        ...
        $("#pasien_data").on('change', function(e) {
            e.preventDefault();
