          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="nama_obat" class="col-form-label"> Nama obat: <span class="text-danger">*</span> </label>
                <input type="text" id="nama_obat" name="nama_obat" class="form-control" placeholder="Nama obat" minlength="0" maxlength="255" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
            ...
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="dosis" class="col-form-label"> Dosis: <span class="text-danger">*</span> </label>
                <input type="text" id="dosis" name="dosis" class="form-control" placeholder="Dosis" minlength="0" maxlength="255" required>
              </div>
            </div>
          </div>
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #nama_obat").val(response.nama_obat);
          $("#data-form #deskripsi").val(response.deskripsi);
          $("#data-form #dosis").val(response.dosis);
