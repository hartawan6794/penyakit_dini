                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="img_user" class="col-form-label"> Photo: </label>
                                <input type="file" id="img_user" name="img_user" class="form-control" placeholder="Nama Lengkap">
                            </div>
                        </div>
                    </div>
                ...
                <form id="password-form" class="pl-3 pr-3">
                    <div class="row">
                        ...
                        <div class="form-group mb-3" id="form-password-konfirmasi">
                            ...
                            <div class="input-group">
                                <input type="password" id="konfirmasi_password" name="konfirmasi_password" class="form-control" placeholder="Password">
                                <!-- <div class="input-group-append"> -->
...
<script>
    $(function() {
        ...
        $("#toggleKonfirmasiPassword").click(function() {
            var passwordInput = $("#konfirmasi_password");
