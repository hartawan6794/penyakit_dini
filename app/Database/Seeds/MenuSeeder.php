...
class MenuSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            ['nama_menu' => 'Riwayat', 'icon' => '<i class="fa fa-history"></i>', 'slug' => 'riwayat', 'content' => '<li class="nav-header ">Riwayat Pendaftaran</li><li class="nav-item"><a href="<?= base_url("riwayat") ?>" class="nav-link <?= $seg == "riwayat" ? "active" : "" ?> "><i class="fa fa-history" aria-hidden="true"></i><p> Riwayat</p></a></li>'],
            ...
            ['nama_menu' => 'Role', 'icon' => '<i class="fa-solid fa-list"></i>', 'slug' => 'roles', 'content' => '<li class="nav-header ">Permissions</li><li class="nav-item"><a href="<?= base_url("roles") ?>" class="nav-link <?= $seg == "roles" ? "active" : "" ?>"><i class="fa-solid fa-list"></i><p>Role</p></a></li></li>'],
